...
由 8 份 PPT 课件整理而成的一套网页教程：**10 个部分、268 页，从数据类型一路讲到 Modern C++**。
...
| 第 1 章 | 数据类型与变量常量 | 22 | 比特与字节、基本类型、变量的本质、常量、`sizeof`、类型转换 |
...
| 第 9 章 | Modern C++ 新特性 | 37 | C++11 讲透，C++14/17/20 概览 |
...
当前状态：**97 段代码全部通过，0 失败**（另有 2 处代码块不参与验证：一处是讲编译过程的
伪代码，一处是汇编）。
