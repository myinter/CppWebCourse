...
(function (global) {
  ...
  var ICONS = {
    ...
    /* ---- C++ 专用 ---- */
    // C++ 标识：六边形 + C + 两个加号，要一眼读成 "C++"。两点讲究：
    //   1. 加号必须是"横竖在中心交叉"的十字 —— 竖线画在横线的一端，
    //      出来的是「⌐」不是「+」，两个并排还会连成一条长横杠；
    //   2. 两个加号并排且等大（不是一高一低）。并排时相邻的横线容易
    //      糊在一起，所以这一个图标的描边收到 1.4（其余图标是 1.8）。
    cpp:       '<g stroke-width="1.4">'
             + '<path d="M12 2 3 6.5v11L12 22l9-4.5v-11L12 2Z"/>'
             + '<path d="M7.05 9.6A2.4 2.4 0 1 0 7.05 14.4"/>'
             + '<path d="M10.25 12h4M12.25 10v4"/>'
             + '<path d="M15.35 12h4M17.35 10v4"/>'
             + '</g>',
    memory:    '<rect x="4" y="4" width="16" height="16" rx="2"/><path d="M9 4v16M15 4v16M4 9h16M4 15h16"/>',
    stack:     '<rect x="3" y="3" width="18" height="4" rx="1"/><rect x="3" y="10" width="18" height="4" rx="1"/><rect x="3" y="17" width="18" height="4" rx="1"/>',
    heap:      '<path d="M12 3 3 9v6l9 6 9-6V9l-9-6Z"/><path d="M3 9l9 6 9-6M12 15v6"/>',
    pointer:   '<path d="M4 6h7a3 3 0 0 1 3 3v6"/><path d="M11 15l3 3 3-3"/><circle cx="4" cy="6" r="2"/>',
    address:   '<circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3M5 5l2 2M17 17l2 2M19 5l-2 2M7 17l-2 2"/>',
    compile:   '<path d="M8 4 4 8l4 4"/><path d="M16 12l4 4-4 4"/><path d="M13 4l-3 16"/>',
    linker:    '<path d="M9 8H7a4 4 0 0 0 0 8h2M15 8h2a4 4 0 0 1 0 8h-2M8 12h8"/>',
    binary:    '<rect x="4" y="4" width="16" height="16" rx="2"/><path d="M9 9h1v6M14 9v6M14 9h2M14 12h1.5M14 15h2"/>',
    bit:       '<circle cx="7" cy="12" r="3"/><circle cx="17" cy="12" r="3"/><path d="M10 12h4"/>',
    recursion: '<path d="M12 3a9 9 0 1 0 9 9"/><path d="M21 3v5h-5"/><circle cx="12" cy="12" r="2.5"/>',
    overload:  '<rect x="3" y="5" width="8" height="5" rx="1.2"/><rect x="3" y="14" width="12" height="5" rx="1.2"/><path d="M15 7.5h6M17 12l4 0M17 12v7"/>',
    reference: '<path d="M8 6h8a3 3 0 0 1 3 3v6"/><path d="M19 15l-3 3-3-3"/><rect x="4" y="4" width="4" height="4" rx="1"/>',
    memoryleak:'<path d="M12 3 4 7v6c0 4 3.4 6.6 8 8 4.6-1.4 8-4 8-8V7l-8-4Z"/><path d="M12 9v4M12 16h.01"/>',
    raii:      '<path d="M12 3 5 6v5c0 3.6 2.9 6.4 7 8 4.1-1.6 7-4.4 7-8V6l-7-3Z"/><path d="M9 12l2 2 4-4"/>',
    lambda:    '<path d="M5 6c0 6 2 12 5 12"/>',
    auto:      '<path d="M4 18 12 5l8 13"/><path d="M7 14h10"/>',
    range:     '<path d="M4 8h16M4 16h16"/><circle cx="9" cy="8" r="2.5" fill="currentColor" stroke="none"/><circle cx="15" cy="16" r="2.5" fill="currentColor" stroke="none"/>',
    smartptr:  '<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="2.5" fill="currentColor" stroke="none"/><path d="M12 4v3M12 17v3M4 12h3M17 12h3"/>',
    move:      '<path d="M4 8h9a5 5 0 0 1 0 10H9"/><path d="M16 5l4 3-4 3"/><path d="M5 15l-3-3 3-3"/>',
    cpp11:     '<path d="M12 2 3 6.5v11L12 22l9-4.5v-11L12 2Z"/><path d="M8 10v4M6 12h4M15 10.5a2.5 2.5 0 1 0 0 3"/>',
    cpp14:     '<path d="M12 2 3 6.5v11L12 22l9-4.5v-11L12 2Z"/><path d="M7 10v4M5 12h4M14 10v4h2.5M14 12h2M18 10v4"/>',
    cpp17:     '<path d="M12 2 3 6.5v11L12 22l9-4.5v-11L12 2Z"/><path d="M6 10v4M4 12h4M13 10v4h2.5M13 12h2M18 10v4"/>',
    cpp20:     '<path d="M12 2 3 6.5v11L12 22l9-4.5v-11L12 2Z"/><circle cx="7.5" cy="12" r="1.8"/><circle cx="12" cy="12" r="1.8"/><circle cx="16.5" cy="12" r="1.8"/>',
    concept:   '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="4"/><path d="M12 3v3M12 18v3"/>',
    thread:    '<circle cx="12" cy="12" r="3"/><path d="M12 3v6M12 15v6M3 12h6M15 12h6"/>',
    guard:     '<path d="M12 3l8 3v6c0 5-3.5 8.2-8 9.5C7.5 20.2 4 17 4 12V6l8-3Z"/><path d="M12 8v4M12 15h.01"/>',
    io:        '<path d="M4 7h16M4 12h16M4 17h10"/><path d="M18 15l3 2-3 2z" fill="currentColor" stroke="none"/>',

    nullptr:   '<circle cx="12" cy="12" r="8"/><path d="M6.3 6.3l11.4 11.4"/><path d="M12 2v2M12 20v2M2 12h2M20 12h2"/>',
    chain:     '<path d="M10 13a4 4 0 0 0 5.7 0l2.6-2.6a4 4 0 0 0-5.7-5.7L11.2 6"/><path d="M14 11a4 4 0 0 0-5.7 0l-2.6 2.6a4 4 0 0 0 5.7 5.7L12.8 18"/>',
    ...
    chip:      '<rect x="5" y="5" width="14" height="14" rx="2"/><path d="M9 9h6v6H9z"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3"/>',
    /* ---- 通用 ---- */
