...
(function (global) {
  ...
  var ICONS = {
    ...
    /* ---- C++ 专用 ---- */
    // C++ 标识：六边形 + C + 两个加号。
    // 加号必须画成"横竖两条线交叉"，且要错开排（一高一低）——
    // 并排放在同一高度时，两个加号的横线会连成一条长横杠，
    // 看起来像 C 后面拖了一串线，而不是 C++。
    cpp:       '<path d="M12 2 3 6.5v11L12 22l9-4.5v-11L12 2Z"/><path d="M8.2 9.3A2.9 2.9 0 1 0 8.2 14.7"/><path d="M11.5 10.2h4.2M13.6 8.1v4.2"/><path d="M15.4 13.4h3.6M17.2 11.6v3.6"/>',
